...
public class DeliveryAddress {
	 ...
	 * @param country
	 */
	public DeliveryAddress(Integer houseNumber, String street, String postalCode, String city, String country) {
		super();
	...
	public String toString() {
		return "DeliveryAddress [houseNumber=" + houseNumber + ", street=" + street + ", postalCode=" + postalCode
